...
export class auctionNft extends ethereum.SmartContract {
  static bind(address: Address): auctionNft {
    return new auctionNft("auctionNft", address);
  }
...
export class ConstructorCall__Inputs {
  ...
  get _auctionHouseAddress(): Address {
...
export class BreakBurnCall extends ethereum.Call {
  get inputs(): BreakBurnCall__Inputs {
    return new BreakBurnCall__Inputs(this);
  }

  get outputs(): BreakBurnCall__Outputs {
    return new BreakBurnCall__Outputs(this);
  }
}

export class BreakBurnCall__Inputs {
  _call: BreakBurnCall;

  constructor(call: BreakBurnCall) {
    this._call = call;
  }
...
export class BreakBurnCall__Outputs {
  _call: BreakBurnCall;
...
export class SetAuctionHouseCall extends ethereum.Call {
  get inputs(): SetAuctionHouseCall__Inputs {
    return new SetAuctionHouseCall__Inputs(this);
  }

  get outputs(): SetAuctionHouseCall__Outputs {
    return new SetAuctionHouseCall__Outputs(this);
  }
}

export class SetAuctionHouseCall__Inputs {
  _call: SetAuctionHouseCall;

  constructor(call: SetAuctionHouseCall) {
    this._call = call;
  }
...
export class SetAuctionHouseCall__Outputs {
  _call: SetAuctionHouseCall;
